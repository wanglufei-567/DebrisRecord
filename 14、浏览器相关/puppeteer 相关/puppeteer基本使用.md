...
**Puppeteer** 是一个 **Node.js** 库，它提供了一组高级 API 来通过 **DevTools 协议** 控制 **Chromium** 或 **Chrome**

**Puppeteer** 默认以 **无头模式** 运行，但可以通过配置选项切换到有头模式
