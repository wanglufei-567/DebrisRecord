...
这里没有提前加载完整工具 schema，而是按任务需要选择命令
...
| 场景 | 更适合 | 原因 |
| ---- | ------ | ---- |
| 个人开发、本地 **AI Coding** | **CLI** | 成本低、模型熟悉、调试方便、组合灵活 |
| 临时脚本、一次性排查 | **CLI** | 不需要封装工具，直接执行命令更快 |
| 已有成熟命令行工具 | **CLI** | 例如 `git`、`rg`、`curl`、`jq`、`docker` |
...
> **CLI** 目前在 **AI Coding** 和个人开发场景中更常用；**MCP** 更适合产品化、云端化、企业化的受控工具调用场景
